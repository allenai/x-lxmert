...
if __name__ == '__main__':
    ...
    parser.add_argument('--cocoroot', type=str, default='../datasets/COCO/')
    ...
    if args.test:
        output_fname = out_dir.joinpath(f'{args.backbone}_{args.split}_boxes{NUM_FEATURES}_test.h5')
